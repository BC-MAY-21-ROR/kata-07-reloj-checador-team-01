...
RSpec.describe "/attendances", type: :request do
  ...
  let(:employee) {Employee.create( name: "Employee name", email: "employee@email.test",private_number: 1, user: current_user)}

  let(:user_new) {User.create(email: 'juanequex@example.com', password: 'password', password_confirmation: 'password', superadmin_role: true, user_role: false)}
  let(:employee_new) {Employee.create( name: "Employee name 2", email: "employeenew@email.test",private_number: 2, user: current_user)}
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested attendance" do
        ...
        attendance.reload
        expect(attendance.user_id).to eql new_attributes[:user_id]
        expect(attendance.employee_id).to eql new_attributes[:employee_id]
      end
